...
<iframe src="{{ '/assets/notebook_html/gdm/gdm_challenge_lab.html' | relative_url }}" width="100%" height="800" frameborder="0"></iframe>

[📄 Download .ipynb]({{ '/assets/notebooks/gdm/gdm_challenge_lab.ipynb' | relative_url }})
